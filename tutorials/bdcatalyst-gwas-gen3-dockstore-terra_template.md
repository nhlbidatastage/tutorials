# Template Blood Pressure Trait GWAS in NHLBI's BioData Catalyst Powered by Terra, Gen3, and Dockstore
...
First, you will use the notebook **1-copy-vcf-to-workspace** to download a tar VCF file of interest to your workspace and extract its content for use in the GWAS. Next, you will need to review what clinical data tables you imported with your selected project from Gen3. 
...
The first notebook you will open, **1-copy-vcf-to-workspace**, will let you select which VCF to copy to your workspace from the Reference File data table and then extract its contents. 
...
4. From within this **2-GWAS-repliminary-analysis** notebook you can call functions from the companion **terra_data_util** notebook to reformat multiple data tables into a single data table that can be loaded as a dataframe in the notebook.
